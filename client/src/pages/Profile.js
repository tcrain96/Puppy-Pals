...
const Profile = () => {
  ...
  const handleDogUpdateClick = (dogId) => {
    ...
    document.getElementById("profile-dog-info-form-" + dogId).style.display =
      "block";
  };

  const handleEventUpdateClick = (eventId) => {
    document.getElementById("profile-event-info-" + eventId).style.display =
      "none";
    document.getElementById(
      "profile-event-info-form-" + eventId
    ).style.display = "block";
  };
  return (
    <section>
      {data && (
        <article className="profile-section">
          <div>
            ...
            <p className="empty-dog-text">{data.me.email}</p>
          </div>
          <AddDogForm />
          <div>
            <h2>My Dogs</h2>
                ...
                <section key={dog._id}>
                  <article id={"profile-dog-info-" + dog._id}>
                    ...
                    <article className="profile-buttons">
                      ...
                      <p onClick={() => handleDogUpdateClick(dog._id)}>
                        Update
                      </p>
                    </article>
                  </article>
                ...
                <section key={event._id}>
                  <article id={"profile-event-info-" + event._id}>
                    ...
                    <article className="profile-buttons">
                      ...
                      <p onClick={() => handleEventUpdateClick(event._id)}>
                        Update
                      </p>
                    </article>
                  </article>
